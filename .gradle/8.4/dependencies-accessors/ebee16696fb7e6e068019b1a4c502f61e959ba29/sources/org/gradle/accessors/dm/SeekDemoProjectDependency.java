...
@NonNullApi
public class SeekDemoProjectDependency extends DelegatingProjectDependency {

    @Inject
    public SeekDemoProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
